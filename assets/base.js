...
var bundleCdnLatest =
  "https://cdn.jsdelivr.net/gh/BinBashBanana/webretro@latest/";
var defaultKeybinds =
...
// Rom list
var romList =
  '<li><b>Quick Play</b></li><li><a href="?core=autodetect&rom=SuperMarioWorld.smc" class="greyer">Super Mario World</a></li><li>________</li>';
...
(function () {
  ...
  if (queries.core) {
    if (!window.navigator.userAgent.toLowerCase().includes("chrom"))
      alert("Best performance on Chrome!");
    ...
    // no core specified
    ffdContent.innerHTML = "<ul>" + romList + aCoreList + "</ul>";
    ffd.style.display = "block";
  }
})();
// ----------- END LOAD -----------
